...
public class SwaggerConfigf {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Utkarsh", "1.0", "Terms of Service",
				new Contact("Utkarsh", "https://www.linkedin.com/in/utkarsh-pravind-510736175/", "1705089@kiit.ac.in"),
